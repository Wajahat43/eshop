...
const useFilteredOffers = (filters: FilterParams) => {
  ...
  const query = useQuery({
    queryKey: ['filtered-offers', priceRange, categories, colors, sizes, page, limit],
    queryFn: async () => {
      ...
      // Call the get-filtered-events endpoint with filters
