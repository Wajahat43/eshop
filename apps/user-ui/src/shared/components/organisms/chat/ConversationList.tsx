...
import { useConversations } from 'apps/user-ui/src/hooks/chat';
  ...
  if (conversations.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full p-8">
        ...
        <p className="text-muted-foreground text-center">Start chatting with shops to see your conversations here.</p>
      </div>
    );
  }
