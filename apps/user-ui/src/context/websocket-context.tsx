...
export const WebSocketProvider: React.FC<WebSocketProviderProps> = ({ user, children }) => {
  ...
  useEffect(() => {
    ...
    const wsUri = process.env.NEXT_PUBLIC_CHAT_WEBSOCKET_URI || 'wss://your-render-app.onrender.com/chat';
